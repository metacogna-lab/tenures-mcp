...
async def calculate_breach_status(
    ...
    from tenure_mcp.schemas.tools import BreachRisk
...
async def extract_expiry_date(
    ...
    from tenure_mcp.schemas.tools import ExtractedDate
...
async def prepare_breach_notice(
    ...
    from tenure_mcp.tools.implementations import calculate_breach_status
    from tenure_mcp.schemas.tools import CalculateBreachInput
